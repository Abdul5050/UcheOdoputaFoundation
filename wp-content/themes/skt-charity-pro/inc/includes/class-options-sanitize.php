...
function of_recognized_background_repeat() {
	...
	$default = array(
		'no-repeat' => __( 'No Repeat', 'skt-charity' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'skt-charity' ),
		'repeat-y'  => __( 'Repeat Vertically', 'skt-charity' ),
		'repeat'    => __( 'Repeat All', 'skt-charity' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'skt-charity' ),
		'top center'    => __( 'Top Center', 'skt-charity' ),
		'top right'     => __( 'Top Right', 'skt-charity' ),
		'center left'   => __( 'Middle Left', 'skt-charity' ),
		'center center' => __( 'Middle Center', 'skt-charity' ),
		'center right'  => __( 'Middle Right', 'skt-charity' ),
		'bottom left'   => __( 'Bottom Left', 'skt-charity' ),
		'bottom center' => __( 'Bottom Center', 'skt-charity' ),
		'bottom right'  => __( 'Bottom Right', 'skt-charity')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'skt-charity' ),
		'fixed'  => __( 'Fixed in Place', 'skt-charity')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'skt-charity' ),
		'italic'      => __( 'Italic', 'skt-charity' ),
		'bold'        => __( 'Bold', 'skt-charity' ),
		'bold italic' => __( 'Bold Italic', 'skt-charity' )
		);
