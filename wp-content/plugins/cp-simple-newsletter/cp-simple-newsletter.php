...
echo' <div class="newslettersign">';
    echo '<input required type="email" name="csn-email" value=""style="background-color:#292929;width:300px;margin-bottom:10px;" placeholder="Email Address"/>';
echo '</div>';
    echo '</p>';
    
    echo '<input type="hidden" name="custom_newsletter_nonce" value="'.wp_create_nonce('custom-newsletter-nonce').'"/>';
    echo '<p><input style="border:none; background:#f25f43; font:14px; color:#ffffff; padding:2.6% 5.3%; border-radius:3px; cursor:pointer;" type="submit" name="csn-submitted" value="'.$button_label.'"/></p>';
    echo '</form>';
